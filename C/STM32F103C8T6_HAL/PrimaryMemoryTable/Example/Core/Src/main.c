...
#if SYNC_WRITE_TEST
		//Change the velocity base target velocity of the servo ID1, ID2 to 360бу/s2 and 720бу/s2, respectively.
...
#if SYNC_WRITE_TEST
		//Change the velocity base target ACC of servo ID1, ID2 to 500бу/s2 and 50бу/s2, respectively.
...
#if SYNC_WRITE_TEST
		//Change the velocity base target DEC of servo ID1, ID2 to 50бу/s2 and 500бу/s2, respectively.
...
#if SYNC_WRITE_TEST
		//Change the velocity base target velocity of the servo ID1, ID2 to 150бу midpoint and 0бу position, respectively.
...
#if SYNC_WRITE_TEST
		//SChange the velocity base target velocity of servo ID1 ,ID2 to 3600 and 3600, position to 0,0, acceleration to 500бу/s2, 500бу/s2, deceleration to 500бу/s2, 500бу/s2, respectively
    servo.velocity[0] = 3600;
    servo.velocity[1] = 3600;
    servo.position[0] = 0;
    servo.position[1] = 0;
...
#if SYNC_WRITE_TEST
		//Change the time base target position and moving time of servo ID1 to 150бу midpoint and 1s, 0бу and 500ms respectively.
    servo.position[0] = 1500;
    servo.position[1] = 0;
    servo.time[0] = 1000;
    servo.time[1] = 500;
...
#if WRITE_TEST
    //Change the min angle limit of servo ID1 to 0бу.
...
#if WRITE_TEST
    //Change the max angle limit of servo ID1 to 300бу.
...
#if WRITE_TEST
    //Change the angle limit of servo ID1 to 0бу~300бу.
...
#if WRITE_TEST
    //Change the max temperature limit of servo ID1 to 65бц.
...
#if WRITE_TEST
    //Change the CW deadband of servo ID1 to 0.2бу.
...
#if WRITE_TEST
    //Change the CCW deadband of servo ID1 to 0.2бу.
...
#if WRITE_TEST
    //Change the CW and CCW deadband of servo ID1 to 0.2бу.
...
#if WRITE_TEST
    //Change the velocity base target velocity of servo ID1 to 360бу/s.
...
#if WRITE_TEST
    //Change the velocity base target ACC of servo ID1 to 500бу/s2.
...
#if WRITE_TEST
    //Change the velocity base target DEC of servo ID1 to 50бу/s2.
...
#if WRITE_TEST
    //Change the velocity base target position of servo ID1 to 150бу.
...
#if WRITE_TEST
    //Change the time base target position and moving time of servo ID1 to 300бу, 500ms respectively.
