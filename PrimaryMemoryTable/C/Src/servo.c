...
{
    servo_pack(id, PING, 0, 0, NULL, output_buffer, output_buffer_len);
...
{
    servo_pack(id, READ_DATA, address, read_data_len, NULL, output_buffer, output_buffer_len);
...
{
    servo_pack(id, FACTORY_RESET, 0, 0, NULL, output_buffer, output_buffer_len);
...
{
    servo_pack(id, PARAMETER_RESET, 0, 0, NULL, output_buffer, output_buffer_len);
...
{
    servo_pack(id, CALIBRATION, 0, 0, NULL, output_buffer, output_buffer_len);
...
{
    servo_pack(id, REBOOT, 0, 0, NULL, output_buffer, output_buffer_len);
